...
create table `user` (
  ...
  `group_list` varchar(255) DEFAULT '' comment '所属所属组ID列表,格式:[id1, id2(,...)]',
...
create table `user_group` (
  ...
  `member_list` tinytext NOT NULL comment '成员id列表,格式:[id1, id2(,...)]',
  PRIMARY KEY (`id`),
...
create table `appointment` (
  ...
  `date` char(8) NOT NULL comment '日期, 格式: 20201102',
  `start_time` char(5) NOT NULL comment '预约开始时间, 格式: 08:00',
  `end_time` char(5) NOT NULL comment '预约结束时间, 格式: 10:00',
  `theme` varchar(100) NOT NULLL comment '会议主题',
  `content` varchar(255) NOT NULLL comment '会议内容简介',
  `group_id` tinytext DEFAULT '' comment '参会组id，格式: 1, 3……',
  `personnel` tinytext DEFAULT '' comment '参会人员id, 格式: 23,26……',
  PRIMARY KEY(`id`),
